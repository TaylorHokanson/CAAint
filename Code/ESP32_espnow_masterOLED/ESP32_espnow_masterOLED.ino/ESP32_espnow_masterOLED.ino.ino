...
void ScanForSlave() {
  ...
  if (scanResults == 0) {
    ...
    Serial.print("Found "); Serial.print(scanResults); Serial.println(" netdevs");
    u8x8.drawString(0, 3, "Found ");
    u8x8.drawString(6, 3, "   ");  //clear device counter before update
    u8x8.setCursor(6, 3);
    u8x8.print(scanResults);
    u8x8.drawString(9, 3, "devices");
  ...
  if (SlaveCnt > 0) {
    ...
    u8x8.drawString(6, 4, "   ");  //clear slave counter before update
    u8x8.setCursor(6, 4);
    u8x8.print(SlaveCnt);
    u8x8.drawString(9, 4, "slaves");
  } else {
...
void OnDataSent(const uint8_t *mac_addr, esp_now_send_status_t status) {
  ...
  u8x8.setCursor(0, 5);
  u8x8.print(macStr); //print mac address of slave target
  Serial.print("Last Packet Send Status: "); Serial.println(status == ESP_NOW_SEND_SUCCESS ? "Delivery Success" : "Delivery Fail");
  u8x8.drawString(0, 6, "Msg Send ");  
  u8x8.setCursor(9, 6);
  u8x8.print(status == ESP_NOW_SEND_SUCCESS ? "SUCCESS" : "FAILURE");
}
...
void setup() {
  ...
  u8x8.drawString(0, 0, "ESPNow Master");
